export const metadata = {
  title: "Contracts",
  description: "Modeltrace Contracts — explore the contracts section.",
};
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white pt-24 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <span className="text-xs font-mono text-white/40 uppercase tracking-widest">/contracts</span>
          <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Contracts</h1>
